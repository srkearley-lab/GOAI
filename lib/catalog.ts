...
export const CATALOG: Record<string, CatalogItem> = {
  ...
  'crm-platform': { group: 'automation', icon: 'Users', amount: 50, recurring: true, unit: 'month',
    label: { EN: 'CRM Platform', GR: 'Πλατφόρμα CRM' }, price: { EN: 'From €350 + €50/month', GR: 'Από €350 + €50/μήνα' },
    ...
    desc: { EN: 'A simple CRM that keeps every lead, customer and deal in one place — so nothing slips through the cracks. €350 setup + €50/month.', GR: 'Ένα απλό CRM που κρατά κάθε lead, πελάτη και συμφωνία σε ένα σημείο — για να μη χάνεται τίποτα. €350 στήσιμο + €50/μήνα.' } },
...
export const FEATURES: Record<string, { EN: string[]; GR: string[] }> = {
  ...
  'crm-platform': { EN: ['Every lead & contact in one place', 'Simple visual deal pipeline', 'WhatsApp & email history per contact', 'Reminders & follow-up tasks', 'Works on phone & desktop', 'Add team members for €20/month each'], GR: ['Κάθε lead & επαφή σε ένα σημείο', 'Απλό οπτικό pipeline συμφωνιών', 'Ιστορικό WhatsApp & email ανά επαφή', 'Υπενθυμίσεις & εργασίες follow-up', 'Λειτουργεί σε κινητό & desktop', 'Προσθήκη μελών €20/μήνα ο καθένας'] },
