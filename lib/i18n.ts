...
export const T: Record<Lang, Record<string, string | string[]>> = {
  EN: {
    ...
    /* sections — home */
    sec_whatwedo_tag: 'What we do', sec_whatwedo_title: 'Everything you need online',
    sec_whatwedo_desc: 'We handle the tech — you run your business.',
    ...
    pricing_selected: 'Selected',
    pricing_continue_add: 'Continue — add your services',
    pricing_pick_hint: 'Pick a website above to start your tailored proposal — then add services, automation and support.',
    pricing_build_plan: 'Build your full plan',
  ...
  GR: {
    ...
    sec_whatwedo_tag: 'Τι κάνουμε', sec_whatwedo_title: 'Ό,τι χρειάζεστε online',
    sec_whatwedo_desc: 'Αναλαμβάνουμε την τεχνολογία — εσείς την επιχείρηση.',
    ...
    pricing_selected: 'Επιλέχθηκε',
    pricing_continue_add: 'Συνέχεια — προσθέστε υπηρεσίες',
    pricing_pick_hint: 'Επιλέξτε ιστοσελίδα παραπάνω για να ξεκινήσετε την εξατομικευμένη πρότασή σας — μετά προσθέστε υπηρεσίες, αυτοματισμούς και υποστήριξη.',
    pricing_build_plan: 'Φτιάξτε το πλήρες πλάνο σας',
